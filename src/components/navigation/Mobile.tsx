...
const MobileNav = () => {
  ...
  return (
    <motion.div
      className={cn('fixed inset-0 w-full h-full md:flex items-center z-[99]')}
    >
      <motion.div
        ...
        className="flex flex-col justify-center items-center gap-8 w-full bg-navbar text-white h-full px-4 md:px-8 py-8 relative"
      >
        <motion.div
          initial={{
            opacity: 1,
