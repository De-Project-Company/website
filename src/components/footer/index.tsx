...
import { NAV_LINKS, PROJECT_LINK } from '@/constants';

const Footer = () => {
  return (
    <footer className="w-full bg-navbar text-white">
      <div className="mx-auto container px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
          <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
            <Link
              href="/?path=home"
              className="flex justify-center lg:justify-start font-rama text-2xl md:text-4xl"
            >
              STARTERSHOUSE
            </Link>
            <p className="py-8 text-sm text-white lg:max-w-xs text-center lg:text-left font-worksans">
              Starters House Community is a hub for tech enthusiasts to connect,
              share knowledge, and grow together. It&apos;s a diverse and
              inclusive platform that fosters continuous learning and
              collaboration. Here, members can build product together, engage in
              discussions, access resources, and participate in events to fuel
              their passion for technology.
            </p>
            <Link
              href="/contact-us"
              className="py-2.5 px-5 h-9 block w-fit bg-nav-text-active rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-nav-text-active/80 lg:mx-0"
            >
              Contact us
            </Link>
          </div>
          ...
          <div className="lg:mx-auto text-left ">
            <h4 className="text-lg text-nav-text-active font-medium mb-7">
              Useful Links
            </h4>
          ...
          <div className="lg:mx-auto text-left">
            ...
            <ul className="text-sm  transition-all duration-500">
              <li className="mb-6">Build project</li>
              <li className="mb-6">Train upcoming Techies</li>
            </ul>
          </div>
          ...
          <div className="lg:mx-auto text-left ">
            ...
            <button className="flex items-center justify-center gap-2 border border-white rounded-full py-3 px-6 w-fit lg:mx-0  text-sm text-white font-semibold transition-all duration-500 hover:bg-indigo-50 hover:text-navbar">
              Subscribe
              <svg
                width="15"
                height="12"
        ...
        <div className="py-7 border-t border-gray-200">
          <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
            <span className="text-sm text-white ">
              ...
              <Link href="/"> Starters House.</Link> All rights reserved.
            </span>
            <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
              <Link
                href="https://x.com/StartersHouse"
              ...
              >
                ...
                <div className="absolute top-full left-0 w-full h-full rounded-full bg-black z-0 transition-all duration-500 group-hover:top-0" />
              </Link>
              ...
              >
                ...
                <div className="absolute top-full left-0 w-full h-full rounded-full bg-red-500 z-0 transition-all duration-500 group-hover:top-0" />
              </Link>
            </div>
          </div>
        </div>
